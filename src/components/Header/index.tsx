          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            >
              <button
                ...
                className="absolute right-4 top-1/2 block -translate-y-1/2 rounded-lg px-2 py-[5px] ring-primary focus:ring-2 lg:hidden"
              >
                <span
                  className={`relative my-1 block h-0.5 w-[22px] transition-all duration-300 ${
